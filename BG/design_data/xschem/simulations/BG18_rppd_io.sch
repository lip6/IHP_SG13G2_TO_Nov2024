...
lab=#net1}
N 1680 -2080 1680 -2030 {
lab=VDD}
N 1360 -2080 1360 -2030 {
lab=VDD}
N 2000 -2080 2000 -2030 {
lab=VDD}
N 1360 -1400 1360 -1350 {lab=#net2}
N 1400 -1450 1420 -1450 {lab=#net2}
N 1560 -1420 1560 -1350 {lab=#net3}
N 1480 -1420 1480 -1350 {lab=#net4}
N 1360 -1560 1390 -1560 {lab=#net5}
N 1480 -1560 1490 -1560 {lab=mpa1}
N 1560 -1560 1590 -1560 {lab=mpa2}
N 1360 -1560 1360 -1480 {lab=#net5}
N 1480 -1560 1480 -1480 {lab=mpa1}
N 1450 -1560 1480 -1560 {lab=mpa1}
N 1560 -1560 1560 -1480 {lab=mpa2}
N 1550 -1560 1560 -1560 {lab=mpa2}
N 1360 -1970 1360 -1560 {lab=#net5}
N 2000 -1410 2000 -1340 {lab=#net6}
N 2000 -1600 2000 -1470 {lab=#net7}
N 1680 -1970 1680 -1560 {lab=#net8}
N 1680 -1560 1680 -1530 {lab=#net8}
N 1650 -1560 1680 -1560 {lab=#net8}
N 1680 -1470 1680 -1450 {lab=mpa10}
N 1420 -1840 1420 -1780 {lab=GND}
N 1520 -1940 1520 -1910 {
lab=gates}
N 1360 -1400 1420 -1400 {lab=#net2}
N 1360 -1420 1360 -1400 {lab=#net2}
N 1420 -1450 1420 -1400 {lab=#net2}
N 1590 -1400 1680 -1400 {lab=#net9}
...
N 1720 -1370 1720 -1350 {lab=#net9}
N 1640 -1350 1650 -1350 {lab=#net9}
N 1640 -1370 1640 -1350 {lab=#net9}
N 1650 -1370 1650 -1350 {lab=#net9}
N 1650 -1350 1660 -1350 {lab=#net9}
N 1660 -1370 1660 -1350 {lab=#net9}
N 1660 -1350 1670 -1350 {lab=#net9}
N 1670 -1370 1670 -1350 {lab=#net9}
N 1670 -1350 1680 -1350 {lab=#net9}
N 1680 -1370 1680 -1350 {lab=#net9}
N 1680 -1350 1690 -1350 {lab=#net9}
N 1690 -1370 1690 -1350 {lab=#net9}
N 1690 -1350 1700 -1350 {lab=#net9}
N 1700 -1370 1700 -1350 {lab=#net9}
N 1700 -1350 1710 -1350 {lab=#net9}
N 1710 -1370 1710 -1350 {lab=#net9}
N 1710 -1350 1720 -1350 {lab=#net9}
N 1590 -1400 1590 -1350 {lab=#net9}
N 1590 -1350 1640 -1350 {lab=#net9}
N 2160 -2080 2160 -2030 {
lab=VDD}
...
N 1490 -1780 1490 -1710 {lab=#net10}
N 1550 -1780 1550 -1710 {lab=#net11}
N 1490 -1650 1490 -1560 {lab=mpa1}
N 1550 -1650 1550 -1560 {lab=mpa2}
N 960 -1860 960 -1840 {lab=#net12}
N 1020 -1860 1020 -1810 {lab=#net12}
N 1000 -1810 1020 -1810 {lab=#net12}
N 960 -1860 1020 -1860 {lab=#net12}
N 1020 -1810 1240 -1810 {lab=#net12}
...
N 1980 -920 2000 -920 {lab=VDD}
N 2000 -960 2000 -920 {lab=VDD}
N 1980 -900 2040 -900 {lab=VDDL}
N 2040 -960 2040 -900 {lab=VDDL}
N 2320 -840 2320 -800 {lab=GND}
N 2300 -840 2320 -840 {lab=GND}
N 2360 -860 2360 -800 {lab=GND}
N 2300 -860 2360 -860 {lab=GND}
N 2300 -920 2320 -920 {lab=VDD}
N 2320 -960 2320 -920 {lab=VDD}
N 2300 -900 2360 -900 {lab=VDDL}
N 2360 -960 2360 -900 {lab=VDDL}
N 2000 -520 2000 -480 {lab=GND}
N 1980 -520 2000 -520 {lab=GND}
N 2040 -540 2040 -480 {lab=GND}
N 1980 -540 2040 -540 {lab=GND}
N 1980 -600 2000 -600 {lab=VDD}
N 2000 -640 2000 -600 {lab=VDD}
N 1980 -580 2040 -580 {lab=VDDL}
N 2040 -640 2040 -580 {lab=VDDL}
N 2320 -520 2320 -480 {lab=GND}
N 2300 -520 2320 -520 {lab=GND}
N 2360 -540 2360 -480 {lab=GND}
N 2300 -540 2360 -540 {lab=GND}
N 2300 -600 2320 -600 {lab=VDD}
N 2320 -640 2320 -600 {lab=VDD}
N 2300 -580 2360 -580 {lab=VDDL}
N 2360 -640 2360 -580 {lab=VDDL}
N 800 -1960 800 -1920 {lab=GND}
N 780 -1960 800 -1960 {lab=GND}
N 840 -1980 840 -1920 {lab=GND}
N 780 -1980 840 -1980 {lab=GND}
N 780 -2040 800 -2040 {lab=VDD}
N 800 -2080 800 -2040 {lab=VDD}
N 780 -2020 840 -2020 {lab=VDDL}
N 840 -2080 840 -2020 {lab=VDDL}
N 560 -2080 560 -2070 {lab=VDD}
N 560 -2010 560 -2000 {lab=#net13}
N 560 -2000 660 -2000 {lab=#net13}
N 780 -2000 960 -2000 {lab=#net12}
N 960 -2000 960 -1860 {lab=#net12}
N 2320 -1800 2320 -1760 {lab=GND}
N 2320 -1800 2340 -1800 {lab=GND}
N 2280 -1820 2280 -1760 {lab=GND}
N 2280 -1820 2340 -1820 {lab=GND}
N 2320 -1880 2340 -1880 {lab=VDD}
N 2320 -1920 2320 -1880 {lab=VDD}
N 2280 -1860 2340 -1860 {lab=VDDL}
N 2280 -1920 2280 -1860 {lab=VDDL}
N 2460 -1840 2560 -1840 {lab=OUT1}
N 2160 -1840 2340 -1840 {lab=#net14}
N 2160 -1970 2160 -1840 {lab=#net14}
N 2320 -1560 2320 -1520 {lab=GND}
N 2320 -1560 2340 -1560 {lab=GND}
N 2280 -1580 2280 -1520 {lab=GND}
N 2280 -1580 2340 -1580 {lab=GND}
N 2320 -1640 2340 -1640 {lab=VDD}
N 2320 -1680 2320 -1640 {lab=VDD}
N 2280 -1620 2340 -1620 {lab=VDDL}
N 2280 -1680 2280 -1620 {lab=VDDL}
N 2460 -1600 2560 -1600 {lab=OUT}
N 2000 -1600 2340 -1600 {lab=#net7}
N 2000 -1970 2000 -1600 {lab=#net7}
N 2320 -1320 2320 -1280 {lab=GND}
N 2320 -1320 2340 -1320 {lab=GND}
N 2280 -1340 2280 -1280 {lab=GND}
N 2280 -1340 2340 -1340 {lab=GND}
N 2320 -1400 2340 -1400 {lab=VDD}
N 2320 -1440 2320 -1400 {lab=VDD}
N 2280 -1380 2340 -1380 {lab=VDDL}
N 2280 -1440 2280 -1380 {lab=VDDL}
N 2460 -1360 2560 -1360 {lab=ADJ}
N 1680 -1560 1810 -1560 {lab=#net8}
N 1870 -1560 2160 -1560 {lab=#net15}
N 2160 -1560 2160 -1360 {lab=#net15}
N 2160 -1360 2340 -1360 {lab=#net15}
...
C {lab_pin.sym} 2560 -1600 0 1 {name=p1 sig_type=std_logic lab=OUT}
...
C {pwroli.sym} 2000 -960 2 1 {name=l17 lab=VDD
}
C {gndoli.sym} 2040 -800 0 0 {name=l23 lab=GND}
C {pwroli.sym} 2040 -960 2 1 {name=l24 lab=VDDL
...
C {pwroli.sym} 2320 -960 2 1 {name=l27 lab=VDD
}
C {gndoli.sym} 2360 -800 0 0 {name=l28 lab=GND}
C {pwroli.sym} 2360 -960 2 1 {name=l29 lab=VDDL
...
C {pwroli.sym} 2000 -640 2 1 {name=l31 lab=VDD
}
C {gndoli.sym} 2040 -480 0 0 {name=l32 lab=GND}
C {pwroli.sym} 2040 -640 2 1 {name=l33 lab=VDDL
...
C {pwroli.sym} 2320 -640 2 1 {name=l35 lab=VDD
}
C {gndoli.sym} 2360 -480 0 0 {name=l36 lab=GND}
C {pwroli.sym} 2360 -640 2 1 {name=l37 lab=VDDL

}
C {tcleval([xschem get current_dirname]/io_ana.sym)} 720 -2000 0 0 {name=x6

model=sg13g2_IOPadAnalog
spiceprefix=X
}
C {gndoli.sym} 800 -1920 0 0 {name=l38 lab=GND}
C {pwroli.sym} 800 -2080 2 1 {name=l39 lab=VDD
}
C {gndoli.sym} 840 -1920 0 0 {name=l40 lab=GND}
C {pwroli.sym} 840 -2080 2 1 {name=l41 lab=VDDL

}
C {isource.sym} 560 -2040 0 1 {name=I1 value="\{iset\}"}
C {pwroli.sym} 560 -2080 2 1 {name=l9 lab=VDD
}
C {tcleval([xschem get current_dirname]/io_ana.sym)} 2400 -1840 0 1 {name=x7

model=sg13g2_IOPadAnalog
spiceprefix=X
}
C {gndoli.sym} 2320 -1760 0 1 {name=l21 lab=GND}
C {pwroli.sym} 2320 -1920 2 0 {name=l42 lab=VDD
}
C {gndoli.sym} 2280 -1760 0 1 {name=l43 lab=GND}
C {pwroli.sym} 2280 -1920 2 0 {name=l44 lab=VDDL

}
C {tcleval([xschem get current_dirname]/io_ana.sym)} 2400 -1600 0 1 {name=x8

model=sg13g2_IOPadAnalog
spiceprefix=X
}
C {gndoli.sym} 2320 -1520 0 1 {name=l45 lab=GND}
C {pwroli.sym} 2320 -1680 2 0 {name=l46 lab=VDD
}
C {gndoli.sym} 2280 -1520 0 1 {name=l47 lab=GND}
C {pwroli.sym} 2280 -1680 2 0 {name=l48 lab=VDDL

}
C {lab_pin.sym} 2560 -1360 0 1 {name=p7 sig_type=std_logic lab=ADJ}
C {tcleval([xschem get current_dirname]/io_ana.sym)} 2400 -1360 0 1 {name=x9

model=sg13g2_IOPadAnalog
spiceprefix=X
}
C {gndoli.sym} 2320 -1280 0 1 {name=l49 lab=GND}
C {pwroli.sym} 2320 -1440 2 0 {name=l50 lab=VDD
}
C {gndoli.sym} 2280 -1280 0 1 {name=l51 lab=GND}
C {pwroli.sym} 2280 -1440 2 0 {name=l52 lab=VDDL

}
C {rppd.sym} 1840 -1560 1 0 {name=R9
w=1e-6
l=6e-6
model=rppd
spiceprefix=X
