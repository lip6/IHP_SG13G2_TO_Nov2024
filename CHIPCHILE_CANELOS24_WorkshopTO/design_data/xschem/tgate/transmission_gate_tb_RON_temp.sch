...
C {devices/ammeter.sym} -50 -100 0 0 {name=Vp}
C {devices/gnd.sym} 110 -570 0 0 {name=l1 lab=GND}
C {devices/vsource.sym} 110 -430 0 0 {name=Vin value=1.1}
...
C {devices/lab_pin.sym} -50 -170 1 0 {name=p6 sig_type=std_logic lab=Vdd}
...
C {devices/ammeter.sym} 620 -100 0 0 {name=Vp1}
C {devices/lab_pin.sym} 620 -170 1 0 {name=p11 sig_type=std_logic lab=Vdd}
