...
S {}
E {}
B 2 590 -710 1390 -310 {flags=graph
...
set color3=blue
set color4=green
hardcopy ILoad_pos.svg V(V_out1) V(V_in) title 'Output voltage drop - positive current flow' xlabel 'Current' ylabel 'Output Voltage' xlog
