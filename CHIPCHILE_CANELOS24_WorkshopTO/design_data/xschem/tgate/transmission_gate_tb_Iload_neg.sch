...
S {}
E {}
B 2 870 -700 1670 -300 {flags=graph
...
set color3=blue
set color4=green
hardcopy ILoad_neg.svg V(V_out2) V(V_in) title 'Output voltage drop - negative current flow' xlabel 'Current' ylabel 'Output Voltage' xlog
