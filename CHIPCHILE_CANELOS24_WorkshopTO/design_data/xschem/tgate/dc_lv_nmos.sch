...
N 70 -0 70 90 {
lab=GND}
C {devices/code_shown.sym} -120 170 0 0 {name=MODEL only_toplevel=true
format="tcleval( @value )"
value=".lib cornerMOSlv.lib mos_tt
"}
C {devices/code_shown.sym} -140 -300 0 0 {name=NGSPICE only_toplevel=true 
value="
.param temp=27
.control
save all 
...
C {devices/vsource.sym} -110 40 0 0 {name=Vgs value=1.2}
C {devices/vsource.sym} 150 0 0 0 {name=Vds value=1.2}
