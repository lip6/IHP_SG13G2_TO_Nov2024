...
save all 
dc I1   10u 100m 10u 
let Ron=(V(V_in)-V(V_out2))/I(Vmeas)
...
set color3=blue
set color4=green
hardcopy ILoad_ron.svg Ron title 'On state resistance' xlabel 'Current' ylabel 'Resistance' xlog

.endc
"}
C {devices/vsource.sym} 110 -620 0 0 {name=Vpow value=1.2}
C {devices/title.sym} -130 260 0 0 {name=l5 author="Copyright 2023 IHP PDK Authors"}
C {devices/launcher.sym} 1030 250 0 0 {name=h5
descr="load waves" 
...
C {devices/ammeter.sym} 390 20 1 0 {name=Vmeas savecurrent=true spice_ignore=0}
